/* Photo du bandeau « vitrine » des pages secondaires
 * (Compétitions, Galerie, Partenaires, Contact).
 *
 ...
 * la photo (et le panneau) prennent le relais.
 *
 * Servi depuis le même domaine : autorisé par la politique de sécurité du site.
 */
(function () {
  var img = document.querySelector('.hero-vitrine-img');
  if (!img) return;
